                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className=" p-4 w-full">
                            ...
                            <div className="button justify-end flex">
                                <Link to={`/adminproductdetail/${product._id}`} type="button" class="inline-block px-4 py-1.5 bg-orange-600 text-white font-medium text-sm leading-tight uppercase rounded shadow-md hover:bg-orange-700 hover:shadow-lg focus:bg-orange-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-orange-800 active:shadow-lg transition duration-150 ease-in-out">Show More</Link>
                            </div>
                        </div>
                    </div>
                </div>
