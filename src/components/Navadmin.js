            ...
            <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto  bg-gray-800">
                    ...
                    <ul className="space-y-2">
                        <li>
                            <Link to="#" className="flex items-center p-2 text-base font-normal  rounded-lg text-white hover:bg-orange-500 dark:hover:bg-gray-700">
                        ...
                        <li>
                            <button onClick={logOut} className="flex items-center p-2 text-base font-normal  rounded-lg text-white hover:bg-orange-500 dark:hover:bg-gray-700">
