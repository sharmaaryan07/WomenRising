        ...
        <div>
            <div className="w-full   rounded-md  bg-white px-4 py-4 shadow-md transition transform duration-500 cursor-default">
                <div className="flex flex-col justify-start  ">
                    ...
                    <div>
                        <div className="mt-5">
                            <Link to={`/adminjobdetail/${job._id}`} className="mr-2 my-1   px-2 text-orange-600 border-orange-600 hover:bg-orange-600 hover:text-white border text-sm font-semibold rounded py-1 transition transform duration-500 cursor-pointer">Detail</Link>
                        </div>
                    </div>
                </div>
            </div>
