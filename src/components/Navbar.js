            ...
            <nav className=" border-gray-200 px-5 py-4 lg:px-7 bg-gray-900  w-full ">
                <div className="flex flex-wrap justify-between items-center  ">
                    <Link to="/" className="flex items-center" >
                        <img src={logo} className="mr-3 h-9  md:h-10  invert" alt="Flowbite Logo" />
                    </Link>
                            ...
                            {isOpen && (
                                <div className="absolute z-20 right-0 w-48 mt-2 py-2 bg-white rounded-md  ">
                                    <div className='lg:hidden  '>
                                        <Link to="/" className="block px-4 py-2 text-gray-800 hover:bg-indigo-500 hover:text-white">Home</Link>
                                        <Link to="/job" className="block px-4 py-2 text-gray-800 hover:bg-indigo-500 hover:text-white">Job</Link>
                                        <Link to="/product" className="block px-4 py-2 text-gray-800 hover:bg-indigo-500 hover:text-white">Product</Link>
                                        <Link to="/blog" className="block px-4 py-2 text-gray-800 hover:bg-indigo-500 hover:text-white">Blog</Link>
                                    </div>
